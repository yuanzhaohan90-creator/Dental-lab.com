...
<link rel="preload" as="image" href="${cover ? escapeHtml(cover.url) : ""}" fetchpriority="high"><link rel="stylesheet" href="/assets/site.css?v=professional-1"></head><body>${previewBanner}
...
${footerMarkup(settings)}<script src="/assets/site.js?v=professional-1" defer></script></body></html>`;
}
